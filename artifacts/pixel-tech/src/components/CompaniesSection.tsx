...
const companies = [
  { name: "Mouri Tech", color: "bg-blue-50 border-blue-200 text-blue-800", logo: "/mouri-tech.jpg" },
  { name: "Amzure Technologies", color: "bg-cyan-50 border-cyan-200 text-cyan-800", logo: "/amzur_technologies.jpg" },
  { name: "Absolin", color: "bg-indigo-50 border-indigo-200 text-indigo-800", logo: "/absolin.png" },
  { name: "Symbiosis", color: "bg-purple-50 border-purple-200 text-purple-800", logo: "/symbiosys.png" },
  { name: "Excel Global Solutions", color: "bg-green-50 border-green-200 text-green-800", logo: "/egh.jpg" },
  { name: "Spruko Technologies", color: "bg-orange-50 border-orange-200 text-orange-800", logo: "/spruko-logo.png" },
];
