...
export default function CTASection({ onApply }: Props) {
  return (
    <section id="contact" className="py-24 relative overflow-hidden">
      ...
      <div className="max-w-6xl relative z-10 mx-auto px-6 text-center">
        ...
        <p className="text-blue-100 text-xl max-w-2xl mx-auto mb-10">
          Join the next cohort of Pixelwind Technologies and start working on real-world machine learning projects today.
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <a
            href="mailto:pixelwindtechnology@gmail.com"
